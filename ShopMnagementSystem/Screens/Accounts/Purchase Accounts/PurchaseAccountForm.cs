...
{
    public partial class PurchaseAccountForm : Form
    {
        DataClasses8DataContext d = new DataClasses8DataContext();
        public PurchaseAccountForm()
        {
            InitializeComponent();
        }
        ...
        private void PurchaseAccountForm_Load(object sender, EventArgs e)
        {
            {
                total.Visible = false;
            ...
            con.Open();
            string str = "SELECT  * FROM [ShopManage].[dbo].[totalpurchasebqayaamount] ";
        ...
        private void newRecordtoolStripButton_Click(object sender, EventArgs e)
        {
            if (IsFormValid())
            {
                ...
                totalPurchaseaccount t = new totalPurchaseaccount();
                ...
                d.totalPurchaseaccounts.InsertOnSubmit(t);
                d.SubmitChanges();
...
SET [Grand Total] = '" + total.Text + "'";
            ...
            }
            {
                ...
                string str = @" UPDATE  [ShopManage].[dbo].[totalpurchasebqayaamount]
SET [bqayaamount] = '" + bqayatextBox1.Text + "'";
        ...
        {
            TotalpurchaseReportForm tf = new TotalpurchaseReportForm();
            tf.ShowDialog();
        }
        ...
        {
            label7.Text = NumberToWord(Convert.ToInt32(bqayatextBox1.Text));
        }
    }
}
