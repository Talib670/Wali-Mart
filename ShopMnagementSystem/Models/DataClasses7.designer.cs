...
namespace ShopMnagementSystem.Models
{
	...
	public partial class DataClasses7DataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertGenralPurchase(GenralPurchase instance);
    partial void UpdateGenralPurchase(GenralPurchase instance);
    partial void DeleteGenralPurchase(GenralPurchase instance);
    #endregion
		
		public DataClasses7DataContext() : 
				base(global::ShopMnagementSystem.Properties.Settings.Default.ShopManageConnectionString1, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses7DataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses7DataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses7DataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses7DataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<GenralPurchase> GenralPurchases
		{
			get
			{
				return this.GetTable<GenralPurchase>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.GenralPurchase")]
	public partial class GenralPurchase : INotifyPropertyChanging, INotifyPropertyChanged
	{
