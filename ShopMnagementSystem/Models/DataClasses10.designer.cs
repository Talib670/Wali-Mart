...
namespace ShopMnagementSystem.Models
{
	...
	public partial class DataClasses10DataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Deletetblclient(tblclient instance);
		...
		public DataClasses10DataContext() : 
				base(global::ShopMnagementSystem.Properties.Settings.Default.ShopManageConnectionString1, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses10DataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses10DataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses10DataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses10DataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnBqaya_AmountChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[Client Name]", Storage="_Client_Name", DbType="NVarChar(100)")]
