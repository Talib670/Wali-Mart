...
namespace ShopMnagementSystem.Models
{
	...
	public partial class DataClasses8DataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InserttotalPurchaseaccount(totalPurchaseaccount instance);
    partial void UpdatetotalPurchaseaccount(totalPurchaseaccount instance);
    partial void DeletetotalPurchaseaccount(totalPurchaseaccount instance);
    #endregion
		
		public DataClasses8DataContext() : 
				base(global::ShopMnagementSystem.Properties.Settings.Default.ShopManageConnectionString1, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses8DataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses8DataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses8DataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataClasses8DataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<totalPurchaseaccount> totalPurchaseaccounts
		{
			get
			{
				return this.GetTable<totalPurchaseaccount>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.totalPurchaseaccount")]
	public partial class totalPurchaseaccount : INotifyPropertyChanging, INotifyPropertyChanged
	{
